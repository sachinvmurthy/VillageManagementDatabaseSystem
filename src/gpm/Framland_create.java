 ...
 * @author raj
 */
public class Framland_create extends javax.swing.JFrame {

    /**
     * Creates new form Framland_create
     */
    public Framland_create() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(722, 529));
        ...
        jLabel2.setText("Size in acres");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(83, 91, 80, 20);

        jLabel3.setText("Type of soil");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(83, 137, 90, 20);

        jLabel4.setText("Water Resource");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(80, 180, 90, 20);

        jLabel5.setText("Farming Technique");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(83, 236, 120, 20);

        jLabel6.setText("Farm ID");
        jPanel2.add(jLabel6);
        ...
        jButton1.setBounds(300, 390, 56, 32);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
       {
           ...
           String query="INSERT INTO farm_lands values('"+n1+"','"+n2+"','"+n3+"','"+n4+"','"+n5+"','"+n6+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Framland_create.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Framland_create().setVisible(true);
            }
        });
    }
