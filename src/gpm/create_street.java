 ...
 * @author raj
 */
public class create_street extends javax.swing.JFrame {

    /**
     * Creates new form create_street
     */
    public create_street() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(727, 531));
        getContentPane().setLayout(null);

        jPanel2.setBackground(new java.awt.Color(254, 254, 254));
        jPanel2.setLayout(null);

        jLabel1.setText("Street no");
        jPanel2.add(jLabel1);
        ...
        jLabel3.setText("Maintainence Date");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(83, 137, 120, 20);

        jLabel4.setText("No of buildings");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(80, 180, 100, 20);

        jLabel5.setText("Money Sanctioned");
        jPanel2.add(jLabel5);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
       {
          ...
          Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/villagedb","sachin","NeverSettle!97");
           ...
           String query="INSERT INTO street VALUES('"+n1+"','"+n2+"','"+n3+"','"+n4+"','"+n5+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(create_street.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new create_street().setVisible(true);
            }
        });
    }
