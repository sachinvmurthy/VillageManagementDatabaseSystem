 ...
 * @author raj
 */
public class create_home extends javax.swing.JFrame {

    /**
     * Creates new form create_home
     */
    public create_home() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(724, 524));
        ...
        jLabel5.setText("Total SQR FOOT");
        jPanel2.add(jLabel5);
        ...
        jLabel7.setText("Occupant name");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(80, 340, 120, 20);

        jLabel8.setText("No of Toilets");
        jPanel2.add(jLabel8);
        ...
        jButton1.setBounds(290, 440, 56, 32);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String n7=jTextField7.getText();
        String n8=jTextField8.getText();
        ...
        try
       {
          ...
          Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/villagedb","sachin","NeverSettle!97");
           ...
           String query="INSERT INTO home VALUES('"+n1+"','"+n2+"','"+n3+"','"+n4+"','"+n5+"','"+n6+"','"+n7+"','"+n8+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(create_home.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new create_home().setVisible(true);
            }
        });
    }
