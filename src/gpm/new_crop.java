 ...
 * @author raj
 */
public class new_crop extends javax.swing.JFrame {

    /**
     * Creates new form new_crop
     */
    public new_crop() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(725, 530));
        ...
        jLabel1.setText("Grown in Fram");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(83, 48, 100, 20);

        jLabel2.setText("Type");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(83, 91, 80, 20);

        jLabel3.setText("Found In");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(83, 137, 90, 20);

        jLabel4.setText("Grown By");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(80, 180, 90, 20);

        jLabel5.setText("Organic");
        jPanel2.add(jLabel5);
        ...
        jButton1.setBounds(300, 360, 56, 32);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
       {
          ...
          Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/villagedb","sachin","NeverSettle!97");
           ...
           String query="INSERT INTO crops VALUES('"+n1+"','"+n2+"','"+n3+"','"+n4+"','"+n5+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(new_crop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
