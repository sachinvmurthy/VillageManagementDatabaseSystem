...
public class s3 extends javax.swing.JFrame {
    ...
    public s3() {
        ...
        try
        {
           ...
           while(rs.next())
           {
               String d1=rs.getString("student_id");
               String d2=rs.getString("Aadhar_no");
               String d3=rs.getString("School_ID");
               String d4=rs.getString("Departemnts");
               String d5=rs.getString("Age");
               String d6=rs.getString("Class");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Aadhar number ", "School ID", "Departement", "Age", "Class"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cteate_student s11=new cteate_student();
        s11.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        delete_student f1=new delete_student();
        f1.setVisible(true);
