...
public class s1 extends javax.swing.JFrame {
    ...
    public s1() {
        ...
        try
        {
           ...
           while(rs.next())
           {
               String d1=rs.getString("School_ID");
               String d2=rs.getString("street_no");
               String d3=rs.getString("Principal_name");
               String d4=rs.getString("School_type");
               String d5=rs.getString("Faculty_stregnth");
               String d6=rs.getString("No_Of_Students");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "School ID", "Stree no", "principal name", "school type", "Faculty Stregnth", "No of Students"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel2.add(jScrollPane1);
        jScrollPane1.setBounds(49, 30, 760, 125);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Create_school s11=new Create_school();
        s11.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        delete_school f1=new delete_school();
        f1.setVisible(true);
