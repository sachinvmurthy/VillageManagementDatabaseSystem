...
public class s2 extends javax.swing.JFrame {
    ...
    public s2() {
        ...
        try
        {
           ...
           String query1="select * from street;";
           ResultSet rs=stmt.executeQuery(query1);
           while(rs.next())
           {
               String d1=rs.getString("street_no");
               String d2=rs.getString("street_name");
               String d3=rs.getString("Maintainence_date");
               String d4=rs.getString("No_of_Buildings");
               String d5=rs.getString("Money_Sanctioned");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Street Number", "Street name", "Maintainnence Date", "No of Buildings", "Money Sanctioned"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel2.add(jScrollPane1);
        jScrollPane1.setBounds(39, 30, 770, 125);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        create_street s11=new create_street();
        s11.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        delete_street f1=new delete_street();
        f1.setVisible(true);
