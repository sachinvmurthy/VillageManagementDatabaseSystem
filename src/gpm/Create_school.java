 ...
 * @author raj
 */
public class Create_school extends javax.swing.JFrame {

    /**
     * Creates new form Create_school
     */
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(724, 527));
        ...
        jLabel3.setText("Principle name");
        jPanel2.add(jLabel3);
        ...
        jLabel5.setText("Faculty strength");
        jPanel2.add(jLabel5);
        ...
        jButton1.setBounds(290, 380, 56, 32);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String schoolid=jTextField1.getText();
        String streetno=jTextField2.getText();
        String principal=jTextField3.getText();
        String schooltype=jTextField4.getText();
        String facultys=jTextField5.getText();
        String nos=jTextField6.getText();
        ...
        try
       {
           ...
           String query="INSERT INTO school VALUES('"+schoolid+"','"+streetno+"','"+principal+"','"+schooltype+"','"+facultys+"','"+nos+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Create_school.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Create_school().setVisible(true);
            }
        });
    }
