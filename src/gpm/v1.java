...
public class v1 extends javax.swing.JFrame {
    ...
    public v1() {
        ...
        try
        {
           ...
           String query1="select * from villager;";
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(870, 567));
        ...
        tb1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Aadhar no", "Name", "Gender", "Dob", "age", "Income", "Number of dependents", "Address ", "Occupation"
            }
        ));
        jScrollPane1.setViewportView(tb1);

        jPanel2.add(jScrollPane1);
        jScrollPane1.setBounds(30, 40, 810, 328);
        ...
        jButton1.setBounds(70, 420, 144, 32);
        ...
        jButton2.setBounds(420, 420, 105, 32);
        ...
        jButton3.setBounds(720, 420, 92, 32);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gpm/vil.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(0, 0, 870, 510);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     create_villager v2=new create_villager();
     v2.setVisible(true);
